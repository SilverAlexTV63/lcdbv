<div class="container">
    <div class="col">
        ...
        <ul>
            ...
            <ul>
                <li><span style="font-weight: bold;">format C4</span> (A4) (22.9cm x 32.4cm) </li>
                <li><span style="font-weight: bold;">timbrée</span> (4 timbres)</li>
                <li><span style="font-weight: bold;">pré-remplies</span> avec les coordonnées de votre restaurant</li>
            </ul>
        </li>
        </ul>
        <p style="text-align: center;"><span style="text-decoration: underline;">Adresse du club</span> :
        <br><span style="font-weight: bold;">Club Des Bons Vivants
        <br>demande d'autocollant et flyers
        <br>34 bis rue des réserves
        <br>63160 BILLOM</span>
        <br><br><br>
    </div>
</div>